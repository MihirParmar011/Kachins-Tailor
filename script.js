    ...
    const searchQuery = encodeURIComponent("Kachins Tailor Mahuva");
    const shopMapURL = `https://www.google.com/search?q=${searchQuery}`;
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      copyToClipboard(randomReview)
        .then(() => console.log("Review copied to clipboard automatically"))
